...
## title: "Weapon Restrictions" description: "Overview of weapon access restrictions by unit type"
...
Whitelisted Tactical Units</span>
...
<td className="px-6 py-4 text-base border border-gray-700">
<span className="text-blue-400">
Whitelisted Certified Units</span>
